            ...
            <form action="<?php echo site_url('franchise-list');?>" method="post" id="frm">
                <div class="row">
                    ...
                    <div class="col-sm-3 col-md-4">
                        ...
                        <input type="text" class="form-control" name="srch_key" id="srch_key"
                            value="<?php echo set_value('srch_key','') ?>"
                            placeholder="Search pincode ,name , phone , mobile or email" />
                    </div>
            ...
            <table class="table table-hover table-bordered table-striped table-responsive">
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $ls['contact_person']?><br /><i class="badge"><?php echo $ls['branch_code']?></i>
                        </td>
                        <td><?php echo '<i class="fa fa-mobile"></i>  '.($ls['mobile']);?><br /><?php echo '<i class="fa fa-phone"></i>  '.($ls['phone']);?><br /><?php echo '<i class="fa fa-envelope"></i> ' . $ls['email']?>
                        </td>
                        ...
                        <td class="text-center">
                            <button data-toggle="modal" data-target="#user_modal"
                                value="<?php echo $ls['franchise_id']?>" class="user_record btn btn-success btn-xs"><i
                                    class="fa fa-users"></i></button>
                        </td>
                        <td class="text-center">
                            <button data-toggle="modal" data-target="#edit_modal"
                                value="<?php echo $ls['franchise_id']?>" class="edit_record btn btn-primary btn-xs"
                                title="Edit"><i class="fa fa-edit"></i></button>
                        </td>
                        <td class="text-center">
                            <button value="<?php echo $ls['franchise_id']?>" class="del_record btn btn-danger btn-xs"
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control" type="text" name="contact_person"
                                            id="contact_person" value="" placeholder="Contact Person Name">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label>Address <i class="text-muted text-sm text-warning"># Mention Business Name & Address [ For Customer Invoice Purpose ]  </i> </label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                         <label>Bank Details: <i class="text-muted text-sm">For Customer Invoice purpose</i></label>
                                        <textarea class="form-control" name="bank_det" placeholder="Bank A/c Details"  id="bank_det">
Name : 
A/c No :
Bank :
Branch:
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input class="form-control" type="text" name="first_name"
                                                    id="first_name" value="" placeholder="Name">
                                            </div>
                                            <div class="form-group col-md-4">
